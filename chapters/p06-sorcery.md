...
**The obligation:** A high Patron Score draws the patron's attention. G4 describes what patrons want and how the relationship escalates. A Patron Score above 50 brings increasingly specific demands.
...
The sorcerer sees through the eyes of a bird within range (intensity 1: line of sight; intensity 2: within 1 km; intensity 3: within 5 km). The sorcerer's body stands still and unseeing while the working holds. The bird is unaware.
...
Creates complete and unnatural darkness within POW metres. No light source within the area functions; sorcerous light not originating inside may penetrate at the GM's discretion. Creatures without other means of perception are effectively blind.
...
The sorcerer prepares a circle, invokes a demon by the appropriate formula, and calls it into physical presence. The demon arrives not bound, and has agreed to nothing - that negotiation follows. The player-side procedure is in §7; the demon's behaviour and demands are in G4.
...
Summoning is an extended ritual followed by a negotiation. The demon's appearance, demands, and behaviour are in G4. This section covers the sorcerer's side.
...
**Gather materials.** G4 describes what a specific demon prefers. Preparing without the appropriate materials imposes penalties on the binding roll.
...
**Binding costs:** 1 permanent POW, plus the demon must fail a POW resistance roll against the sorcerer's current PP total. If the demon succeeds, it is not bound - and is usually unhappy.

**Types of binding:**

- _Flesh binding:_ bound to the sorcerer's service directly; follows commands; cannot harm the sorcerer.
- _Object binding:_ bound into a weapon, amulet, or container; power accessible through the object; cannot act independently.
- _Place binding:_ bound to a location; cannot leave but has great power within it.
...
- **The demon is destroyed.** Binding ends immediately; permanent POW cost is not recovered.
