...
## 4.3 Buying a Critical

Buying a Critical is a Fate Point spend with a variable cost - it has its own section because the cost is calculated from the dice rather than being fixed. The Critical Buy draws from the same PP pool as every other Fate Point spend. See §8 for the rest of the menu.
...
- A roll forced to success by Push Through (§8.5) is not eligible for a Critical Buy. The two spends cannot chain on the same roll: you cannot buy your way from a failure to a success to a critical.
- A roll that has been re-rolled (§8.1) is not eligible for a Critical Buy.

Sorcerer PCs: every PP spent on a Critical Buy is a PP unavailable for casting. See §7.1.

## 4.4 Special Skill Rolls

### 4.4.1 Opposed Skill Rolls
...
### 4.4.3 Complementary Skills and Augments
...
**Augment.** An augment is a riskier, more powerful version of the complementary bonus: the character makes a full roll against the supporting skill, and the outcome modifies the difficulty of the primary action:
...
### 4.6.4 What Spends Power Points
...
### 4.7.2 Trust the Fates (Cost: 5 PP)
...
### 4.7.3 Shrug Off a Blow (Cost: 2 PP per point of damage negated)
...
### 4.7.4 Ignore a Fumble (Cost: 6 PP)
...
### 4.7.6 Stand Your Ground (Cost: 2 PP, then 2 PP more each consecutive round)
...
### 4.7.7 Deflect the Killing Blow (Cost: all remaining PP, minimum 8)
...
### 4.7.9 Rally From the Wound (Cost: 8 PP)
...
## 4.8 Experience and Improvement

### 4.8.1 Earning Experience Checkmarks
...
### 4.8.5 Characteristic Improvement
