...
### 2.3.6 Skill Category Bonuses (REMOVE THIS)
...
Profession is what the character did before play begins. Choose one from §4 and take its skill bundle, wealth tier, and starting Reputation. The rules for distributing profession skill points are given there.
...
| Battle Tempo       | 3 PP | Declare before initiative is rolled this round. Treat your DEX as +5 for the initiative roll only. The bonus does not affect skill rolls, Dodge, or damage modifier - it changes only the order in which you act. Once per combat.                                              |
...
## 2.8 Step 7: Passions (CONSIDER REMOVAL OR CHANGE - DEBTS, LIKE IN FFG STAR WARS?)
...
- **Fumble:** The character is overcome with Despair. Apply -1D10% permanently to the Passion rating. The character is incapacitated by emotion for 1D3 rounds. When they recover, the scene continues.

**Each Passion may be invoked once per scene.** The player chooses when.

**Mandatory rolls at 80%+.** A character with a Passion rated at 80% or above cannot easily ignore it when directly provoked. The GM may require a Passion roll when the character acts contrary to a high-rated Passion. On a fumble, the character's will fails and they follow the Passion despite their intentions. The character always has two options to avoid mandatory rolls: reduce the Passion below 80% voluntarily, or invoke a conflicting Passion in opposition.

**Conflicting Passions.** When two Passions point in opposite directions, make an opposed roll of both against each other. The higher success tier wins; ties go to the higher-rated Passion.
...
Reputation is fame - or notoriety - recognised beyond the character's home ground. It is not the same as Status (see §3.4.40); Reputation travels. Reputation is a one-way ratchet: it only increases, never decreases.
...
**Impressing others.** A player may invoke their character's Reputation as an augment to a Communication skill roll (Persuade, Bargain, Command, Fast Talk). Roll Reputation before the Communication roll:

- **Critical:** +50% to the Communication skill
- **Success:** +20%
...
- **Affluent:** Up to 50 Staters in coin, property, or credit.
- **Wealthy:** Up to 3 Suns in coin, property, or credit - or an equivalent stake in a business.
...
3. **What are you running from?** Is it still behind you?
4. **Who do you owe a debt to that you cannot easily repay?** Do they know they hold the debt?
5. **What one possession are you never without, and why?** (This becomes your significant possession - see below.)
6. **What have you done that most people wouldn't forgive?** Does anyone know?
...
- Category bonuses and all skill ratings (base + category + background + profession + personal)
