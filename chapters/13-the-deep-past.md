...
Talents:
  ...
  Hard To Kill - Spend 4 PP after taking a critical hit; the §A1
...
- **Damage Modifier:** +1D4
- **Attacks:** Rending Claws 70% / 1D6+1+dm (Slash); Throat-Strike 1D10+dm (after a surprise or Easy attack; §A1 Pierce table on a critical).
- **Special Abilities:**
...
- **Special Abilities:**
  ...
  - _Immune to Pain._ §A1 critical effects that impose stunning, impairment, or "useless limb" status have no effect; damage and permanent destruction still apply normally. Only physical destruction halts them.
