# Warrior \* Sorcerer \* Rogue - Design Document

> The "north star" for every rules decision. Read first when touching any rules question; update when the genre understanding sharpens.

---

## 1. Genre Definition

### 1.1 Literary Touchstones

The system draws on three primary authors:

- **Robert E. Howard** (Conan, Kull, Solomon Kane) - the centre of gravity. Primal, brutal, civilization vs barbarism, the lone hero in a hostile world. Adventures end in blood and the hero walking away.
- **Fritz Leiber** (Fafhrd & the Grey Mouser) - the urban accent. Picaresque, sardonic, two-rogue dynamic, fog-shrouded thieves' guilds. Adventures end in wit and a stolen purse.
- **Michael Moorcock** (Elric of Melniboné, the Eternal Champion) - the sorcerous and cosmic accent. Doomed, decadent, magic-as-curse. Adventures end in tragedy or terrible knowledge.

Secondary inspirations, permitted to colour scenarios:

- **Edgar Rice Burroughs** (John Carter of Mars) - the planetary romance / sword-and-planet thread. Lost civilizations on dying worlds, ancient super-science indistinguishable from sorcery.
- **Clark Ashton Smith** (Hyperborea, Zothique) and the broader **Weird Tales** tradition - the eldritch and decadent edges.
...
6. **Sorcery as costly choice.** Magic exists, and PCs can pursue it. Every step into it costs something - corruption, debts to powers, the attention of things that shouldn't notice you. The spells themselves (their descriptions and effects) carry the tone.
7. **Naturalistic healing.** Recovery is herbal, restful, and slow. No white mages with Cure spells. Wounds matter and persist.
8. **Episodic, not epic.** Stories are standalone adventures, heists, vendettas. Sessions feel like short stories rather than chapters of a save-the-world novel.
...
- **High fantasy heroism.** No saving the world, no Dark Lord to overthrow.
...
The default tone is **Howard's**: muscular, energetic, blood-soaked, swaggering. A session should feel like you're inside a pulp adventure - things happen fast, stakes are immediate, victories are bought with sweat and luck.

Two accent tones are explicitly supported and the system should make them easy to reach for:

- **Leiber's wit** colors urban and picaresque scenarios: city heists, thieves' guild plots, sardonic banter under threat, schemes within schemes.
- **Moorcock's doom** colors sorcerous and cosmic scenarios: encounters with patrons, dealings with old powers, the sense that the universe is older and crueler than the heroes know.

A campaign can sit anywhere on this triangle. A single session can shift mode - a Howard-flavored adventure takes a Moorcock turn the moment a sorcerer enters the picture.

### 2.2 Magic

Magic feels **alien, costly, and corrupting**. Even small spells carry a sense that the caster has done something they probably shouldn't have. Spells are not utility tools; they are transactions with things beyond the world.

The **spell descriptions themselves** do most of the work of communicating this. A spell entry is not a stat block - it's a brief invocation of dread: what it does, what it costs, what it implies about the caster's relationship with the power they have drawn from. (The exact mechanical cost framework is deferred to the magic chapter, where it will be designed against whatever BRP UGE provides.)

Aesthetic principles for the spell list, regardless of the eventual mechanic:
...
The combat aesthetic is **muscular, decisive, and brutal**. Encounters should feel like they cost something even when won.

### 2.4 The World

The world feels **ancient, layered, and unsafe**. Visible cultures - the cities, courts, kingdoms PCs walk through - are usually the most recent stratum sitting on top of older, stranger ones. Ruins are everywhere, mostly unmapped, mostly unsafe. The skies have stranger constellations than the historians admit.

Tonal markers:

- **Real-world ancient flavor.** Mediterranean, Levantine, Mesopotamian, Persian, Steppe. Bronze and iron age. Wine, olives, salt, bone, bronze, papyrus.
- **Decadent civilization.** Cities are cosmopolitan, corrupt, hierarchical. Courts and temples are dangerous places.
- **Hostile wilderness.** Wilds are full of beasts, raiders, ruins, and stranger things.
- **The deep past breathing.** Place names, monuments, and language fragments hint at ages older than recorded history.

### 2.5 The Heroes

PCs are **outsiders, anti-heroes, and exceptional individuals**. They are at the upper edge of human ability in their archetype - the strongest barbarian their tribe produced, the cleverest thief in their port, the most learned of a small dark order of sorcerers. They are not, however, superhuman.

Aesthetically:

- **Grounded extraordinariness.** They look like real people pushed to their physical and mental limits, not Marvel heroes.
- **Sweat and scars.** PCs accumulate visible marks of adventure - broken noses, skin-deep scars, arcane brands, missing fingers.
- **Personal codes.** Every PC has lines they will not cross, debts they pay, oaths they keep. These are personal, not universal.
- **Outsider status.** Few PCs are respected establishment figures. They are foreigners, exiles, criminals, defrocked priests, deserters, runaways.
...
- **Center the genre in every chapter.** Skills are ancient-world skills. Equipment is bronze-and-iron-age. Combat assumes the genre's pulp pacing. Magic assumes the genre's costly sorcery. Even chargen reflects the anti-hero / outsider archetype.
...
The system explicitly will not:
...
Things deferred to chapter-time decisions:

- **Sorcery's cost mechanic.** Deferred to the magic chapter (see §2.2).
...
A session is a **short story**. Some are heists (steal the thing, escape with it). Some are vendettas (find the man, kill him). Some are explorations (descend into the ruin, retrieve the relic, escape). Most resolve in a single sitting; the longer ones span two or three.

A session opens with the **hook** (a job offered, a debt called in, a chance encounter that demands response), proceeds through **complications** (the thing is harder than promised; betrayal; sorcery), and closes with a **reckoning** (the heroes succeed at cost, fail expensively, or escape with parts of what they came for).
...
### 4.5 Across Many Sessions

A campaign is a **string of stories**, like an anthology of Conan tales. Recurring elements knit them together: an antagonist who keeps escaping, a patron who keeps coming back with new jobs, a sorcerer's debt that grows, a city the heroes return to, a vow they have not yet been able to keep.

PCs grow in **experience and reputation**, not raw power. A twentieth-session Conan is not statistically far from a first-session Conan; he is more famous, has more enemies, has more scars, and has a wider repertoire of skills. He is not a demigod.

The world also grows. Old enemies return. Old patrons reveal new agendas. Old debts come due. Sessions accumulate weight without inflating into world-saving epics.
